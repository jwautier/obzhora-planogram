...
function shelfBeyondRack(shelf) {
	return shelf.x1 < 0
		...
		|| shelf.y3 < 0
		|| shelf.y4 < 0
		|| shelf.x1 > window.rack.width
		|| shelf.x2 > window.rack.width
		|| shelf.x3 > window.rack.width
		|| shelf.x4 > window.rack.width
		|| shelf.y1 > window.rack.height
		|| shelf.y2 > window.rack.height
		|| shelf.y3 > window.rack.height
		|| shelf.y4 > window.rack.height;
}