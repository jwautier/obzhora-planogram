...
public class TestRackWaresModel {
	...
	public static void testRackWaresModel(final UserContext userContext) throws SQLException {
		...
		final Rack rack = new Rack(sector.getCode_sector(), null, "rack 1", "1", length, width, height, 1000, 1000, 0, LoadSide.F, null, false, false, TypeRack.R, null, null, null, null, length, width, height, 0, 0, 0);
