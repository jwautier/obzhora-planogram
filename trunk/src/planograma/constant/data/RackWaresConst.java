...
public interface RackWaresConst {
	...
	public static final String WARES_WIDTH = "wares_width";
	public static final String WARES_HEIGHT = "wares_height";
	public static final String COUNT_LENGTH_ON_SHELF = "count_length_on_shelf";
