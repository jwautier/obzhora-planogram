 ...
 * Time: 9:50
 */
@WebServlet("/" + UrlConst.URL_SECTOR_CAN_SET_STATE)
public class SectorCanSetState extends AbstractAction {

	public static final String URL = UrlConst.URL_SECTOR_CAN_SET_STATE;

	private static final Logger LOG = Logger.getLogger(SectorCanSetState.class);
	...
	protected JsonObject execute(HttpSession session, JsonElement requestData) throws UnauthorizedException, SQLException {
		...
		jsonObject.addProperty("state", sectorState.getState_sector().name());
