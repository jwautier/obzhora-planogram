 ...
 */
@WebServlet("/" + UrlConst.URL_RACK_PRINT_A + "*")
public class RackPrintStateA extends AbstractRackPrint {
	public static final String URL = UrlConst.URL_RACK_PRINT_A;
	...
	public Date getDate(UserContext userContext, int code_rack) throws SQLException {
		RackState rackState = rackStateHModel.selectA(userContext, code_rack);
		Date date = null;
		if (rackState != null)
			date = rackState.getDate_active();
		return date;
	}
